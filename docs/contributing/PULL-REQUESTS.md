...
* [Reviewing Pull Requests](#reviewing-pull-requests)
  ...
  * [Accept that there are different opinions about what belongs in Digital Logic Sim](#accept-that-there-are-different-opinions-about-what-belongs-in-project-sample)
...
More details to come on Digital Logic Sim dependencies. In case of doubt, open an issue in the
[issue tracker](https://github.com/Highlandword9/Digital-Logic-Sim/issues/)<!-- or engage on the 
...
Fork the project [on GitHub](https://github.com/Highlandword9/Digital-Logic-Sim/) and clone your fork
locally.

```text
$ git clone git@github.com:Highlandword9/Digital-Logic-Sim.git
$ cd Digital-Logic-Sim
$ git remote add upstream https://github.com/Highlandword9/Digital-Logic-Sim.git
$ git fetch upstream
```
...
Digital Logic Sim does not yet have a style guide.
...
Fixes: https://github.com/Highlandword9/Digital-Logic-Sim/issues/1337
